...
export const Chat = memo(({ stopConversationRef, refetch }: Props) => {
  ...
  const handleSend = useCallback(
    async (message: Message, deleteCount = 0, plugin: Plugin | null = null) => {
      if (selectedConversation) {
        ...
        console.log('chat model: ', updatedConversation.model)
  ...
  return (
    <div className="relative flex-1 overflow-hidden bg-white dark:bg-[#171717]">
          ...
          >
            {selectedConversation?.messages.length === 0 ? (
              ...
              <>
                ...
                <div
                  className="h-[162px] bg-white dark:bg-[#171717]"
                  ref={messagesEndRef}
                />
              </>
            )}
